...
public class EmployeeRepositoryImpl implements EmployeeRepository {
    ...
    public int AddEmployee(Employee employee) {
        try{
            System.out.println("Came to ADD EMPLOYEE");
            System.out.println(employee);
            String sql="INSERT INTO employees (emp_fname,emp_lname,emp_email,emp_gender,emp_join_date)"+
                    " VALUES (?,?,?,?,?)";
            return jdbcTemplate.update(sql, employee.getEmp_fname(),employee.getEmp_lname(),
